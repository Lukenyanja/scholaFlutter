...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: ScholarshipfinderWidget.routeName,
          path: ScholarshipfinderWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'scholarshipfinder')
        ...
        FFRoute(
          name: ScholarshipDetailsWidget.routeName,
          path: ScholarshipDetailsWidget.routePath,
          builder: (context, params) => ScholarshipDetailsWidget(
        ...
        FFRoute(
          name: ScholaAI2Widget.routeName,
          path: ScholaAI2Widget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'ScholaAI2')
              : ScholaAI2Widget(),
        ),
        FFRoute(
