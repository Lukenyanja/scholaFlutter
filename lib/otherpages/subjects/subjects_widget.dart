...
class _SubjectsWidgetState extends State<SubjectsWidget>
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      future: ScholarshipsGroup.multiFilterCall.call(
        categoryS: 'subject',
        valueS: widget.queryName,
      ),
      builder: (context, snapshot) {
        ...
        final subjectsMultiFilterResponse = snapshot.data!;
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              16.0, 12.0, 16.0, 16.0),
                          child: Text(
                            'If you wish to study  ${widget.queryName},  these scholarships are for you please  browse through to find the best scholarship for you',
                            style: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                                  font: GoogleFonts.inter(
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Builder(
                                builder: (context) {
                                  final subjectSchlarships = getJsonField(
                                    subjectsMultiFilterResponse.jsonBody,
                                    r'''$.results''',
                                  ).toList();
                                  ...
                                  return ListView.separated(
                                    ...
                                    itemCount: subjectSchlarships.length,
                                    separatorBuilder: (_, __) =>
                                        SizedBox(height: 8.0),
                                    itemBuilder:
                                        (context, subjectSchlarshipsIndex) {
                                      final subjectSchlarshipsItem =
                                          subjectSchlarships[
                                              subjectSchlarshipsIndex];
                                      return InkWell(
