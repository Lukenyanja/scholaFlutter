...
DocumentReference? get currentUserReference =>
    loggedIn ? QuizQuestionsRecord.collection.doc(currentUser!.uid) : null;

QuizQuestionsRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : QuizQuestionsRecord.getDocument(
                  QuizQuestionsRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
